...
//
//        log.info("getCurrentAdmin()-->" + token);
...
//        }
        ...
        String kk = "{\n" +
                ...
                "    \"exp\": 1658819213,\n" +
                "    \"authorities\": [\"1_超級管理员\"],\n" +
                "    \"jti\": \"b490c898-689b-484d-b8e2-987f366b198b\",\n" +
                "    \"client_id\": \"admin-app\"\n" +
                "}";
        log.info("kk-->"+kk);
        UserDto userDto = JSONUtil.toBean(kk, UserDto.class);
        log.info("getCurrentAdmin() id -->" + userDto.getId());

        UmsAdmin admin = baseMapper.selectById(userDto.getId());
